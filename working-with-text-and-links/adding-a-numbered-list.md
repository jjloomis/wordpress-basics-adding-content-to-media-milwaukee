...
4. To create an indented list item, press **Enter** or **Return** (on keyboard) to add a list item. Then press the **Tab** key (on keyboard) to create an indented item.
5. To un-indent a list item, press the **Delete** key (on keyboard).&#x20;

<figure><img src="../.gitbook/assets/adding-a-numbered-list.png" alt="Adding a numbered list to a WordPress Post. "><figcaption></figcaption></figure>
