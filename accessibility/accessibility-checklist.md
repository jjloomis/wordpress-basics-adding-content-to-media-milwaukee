...
To comply with Title II of the Americans with Disabilities Act (ADA), Media Milwaukee Posts must meet the accessibility standards stipulated in the Web Content Accessibility Guidelines (WCAG) Version 2.1, Level AA (the technical standard for state and local governments’ web content and mobile apps).

While the items listed below are not an exhaustive list of all ADA Title II WCAG 2.1 AA guidelines, these are the guidelines Contributors and Editors will most likely encounter when creating and publishing Posts in Media Milwaukee.&#x20;
...
When adding Headings/Subheadings to a post, use the Heading block. This will create an H2 style heading within the Post. In general, an H2 style heading is the only type of heading Media Milwaukee contributors should be adding to a post. Note: Do not make the Heading bold (it is already bold).
