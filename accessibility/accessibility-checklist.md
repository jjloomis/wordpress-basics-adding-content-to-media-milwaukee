...
When adding headings/subheadings to a post, use the Heading block. This will create an H2 style heading within the post. In general, an H2 style heading is the only type of heading a Media Milwaukee Contributors should add to a post. Note: Do not make the heading bold (it is already bold).
